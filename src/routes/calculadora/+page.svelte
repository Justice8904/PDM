    ...
    <table class="table table-borderless table-sm">
        <tbody>
            ...
            <tr>
                ...
                <td><button type="button" class="btn btn-outline-warning w-100" onclick={() => press("*")}>X</button></td>
                <td><button type="button" class="btn btn-outline-warning w-100" onclick={() => press("Math.sqrt(")}>&radic;</button></td>
            ...
            <tr>
                ...
                <td><button type="button" class="btn btn-outline-warning w-100" onclick={() => press("Math.round(")}>Round</button></td>
            ...
            <tr>
                ...
                <td><button type="button" class="btn btn-outline-warning w-100" onclick={() => press("Math.log(")}>Log</button></td>
            </tr>
            <tr>
